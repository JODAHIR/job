...
const $=id=>document.getElementById(id);let selected='',items=[],expectedUpdatedAt=null;const fields=['title','questions','support','steps','hours','good','bad'];
function status(text){$('status').textContent=text}
function reset(){selected='';expectedUpdatedAt=null;clearHistory();$('editor').reset();$('published').checked=false;$('edit-title').textContent='Nuevo procedimiento'}
...
$('procedure-search').oninput=()=>renderLibrary(items,selected,edit);
